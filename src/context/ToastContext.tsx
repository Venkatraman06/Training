      ...
      <div style={{
        ...
        {toasts.map((toast) => (
          <div key={toast.id} style={{
            ...
            boxShadow: '0 10px 30px rgba(0,0,0,0.1)', borderLeft: `4px solid ${toast.type === 'success' ? 'var(--color-success)' : toast.type === 'error' ? 'var(--color-error)' : 'var(--color-info)'}`,
            ...
            <span style={{ fontSize: '14px', color: 'var(--color-espresso)', fontWeight: '500' }}>{toast.message}</span>
